...
```
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/binhnguyenduc/dotfiles/main/sw/assets/executable_install.sh)"
```
...
```
cd $HOME
chezmoi init git@github.com:binhnguyenduc/dotfiles.git
